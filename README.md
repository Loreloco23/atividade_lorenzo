# atividade_lorenzo
Dúvidas: podem me mandar mensagem no Teams. 
Olá, LORENZO. Quando você enviar este formulário, o proprietário verá seu nome e endereço de email.
Obrigatória
1.Peça ao usuário seu nome e cumprimente utilizando a função print(), ex.: "Olá, Carol!"
https://github.com/Loreloco23/atividade_lorenzo.git
